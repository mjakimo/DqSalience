...
def load_and_format_data():
    ...
    print(f"Found {len(json_files)} data files. Assembling prompts with Qwen ChatML template...")
    formatted_data = []
...
checkpoint_dir = "./qwen_native_lora"
...
trainer.model.save_pretrained("./qwen_native_lora_final")
tokenizer.save_pretrained("./qwen_native_lora_final")
